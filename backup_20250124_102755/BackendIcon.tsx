...
export const BackendIcon: React.FC<BackendIconProps> = ({ className }) => {
    ...
    <div ref={containerRef} className={`w-full h-full relative cursor-pointer ${className}`}>
      <svg viewBox="0 0 24 24" className="w-full h-full">
        ...
        <g className="dark:opacity-90">
          {/* Circuit Pfade */}
          <g ref={circuitRef} className="stroke-primary/30 dark:stroke-primary/40">
            {/* Horizontale Pfade */}
            <path
          ...
          <g ref={centerBlockRef}>
            ...
            <rect
              ...
              height="14"
              rx="3"
              className="fill-white stroke-primary/40 dark:fill-background-dark dark:stroke-primary"
              strokeWidth="0.8"
            />
            ...
            <rect
              ...
              height="12"
              rx="2"
              className="fill-primary/10 stroke-primary/30 dark:fill-primary/30 dark:stroke-primary"
              strokeWidth="0.6"
            />
            ...
            <text
              x="12"
              y="13"
              className="text-[4.5px] font-bold fill-primary/70 dark:fill-primary text-center"
              textAnchor="middle"
            >
              API
            </text>
            ...
            {/* Verbindungspunkte */}
            <circle cx="12" cy="6" r="0.7" className="fill-primary/40 dark:fill-primary/60" />
            <circle cx="12" cy="18" r="0.7" className="fill-primary/40 dark:fill-primary/60" />
            <circle cx="6" cy="12" r="0.7" className="fill-primary/40 dark:fill-primary/60" />
            <circle cx="18" cy="12" r="0.7" className="fill-primary/40 dark:fill-primary/60" />
          </g>
        </g>
      </svg>
    </div>
