...
export const AIIcon: React.FC<AIIconProps> = ({ className }) => {
  ...
  return (
    <div ref={containerRef} className={`w-full h-full relative cursor-pointer flex items-center justify-center ${className}`}>
      {/* Animierter 3D Boden */}
